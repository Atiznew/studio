...
import { CheckCircle, UploadCloud, Youtube, Instagram, Send, Loader2 } from 'lucide-react';
                  ...
                  <FormItem>
                    <div className="flex justify-between items-center">
                        ...
                        <Button
                            ...
                            variant="link"
                            size="sm"
                            disabled={isGenerating || uploadType !== 'direct'}
                            className="text-primary disabled:text-muted-foreground"
                        >
                            {isGenerating ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Generating...</> : "Auto-generate with AI"}
                        </Button>
                    </div>
                    <FormControl>
