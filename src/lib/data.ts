...
export const users: User[] = [
  { id: 'u1', name: 'Alex Doe', avatarUrl: placeholderImages.find(p => p.id === 'avatar-1')?.imageUrl || '', bio: 'Travel enthusiast & storyteller. Exploring the world one city at a time.' },
  { id: 'u2', name: 'Jane Smith', avatarUrl: placeholderImages.find(p => p.id === 'avatar-2')?.imageUrl || '', bio: 'Mountain lover and avid hiker. Always looking for the next peak to conquer.' },
];
